...
{
    //https://www.grapecity.com/componentone/docs/webapi/online-webapi/CustomAuthorization.html
    public class StorageAuthorizeAttribute : AuthorizationFilterAttribute
    {
        ...
        private static readonly IDictionary<string, IEnumerable<string>> _folderRoles = new Dictionary<string, IEnumerable<string>>(StringComparer.OrdinalIgnoreCase);
